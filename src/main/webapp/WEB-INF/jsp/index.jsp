		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<div id="previews" class="row">
					<div class="col-12">
						<form id="formdonefilter" action="${pageContext.request.contextPath}/index" method="TODO : remplir">
									...
									<div class="media border p-3">
										...
										<div class="media-body">
											...
											<div class="row">
												<div class="col">
													<i class="${ food.name }"></i>
													<c:out value="${ food.tag }" />
												</div>
												<div class="col">
													<form id="tagselectform" action="${pageContext.request.contextPath}/food/tagguer" method="POST">
														<input type="hidden" value="${food.id }" name="tagId" />
											...
											<div class="row">
												...
												<div class="col">
													<form action="${pageContext.request.contextPath}/food/tagguer" method="POST">
														<input type="hidden" value="${food.id }" name="tagId" />
														<c:choose>
															<c:when test="${food.done }">
																<button name="buttonFav" type="submit" class="btn btn-success btn-xs" ><i class="fas fa-check"></i> DONE</button>
															 </c:when>
															 
															<c:otherwise>
																<button name="buttonFav" type="submit" class="btn btn-warning btn-xs" ><i class="fas fa-exclamation"></i> TODO</button>															
															</c:otherwise>
														</c:choose>
													</form>
												</div>
